...
package Task2_3
  package Task2a
    ...
    model ElectricEIRConst "Chiller Electric EIR with Water - Air Cooling Coil"
      ...
      Task2_3.Task2c.ElectricEIRCW chi(
      ...
      Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaData(filNam=
            "C:/Users/ucbqtw1/Desktop/Elements/Project 2/ESP_Barcelona.081810_SWEC.mos")
      ...
      Buildings.Fluid.Sensors.TemperatureTwoPort TAirOut(
        ...
        "Temperature of air leaving cooling coil" annotation (Placement(
            ...
            rotation=0,
            origin={-40,-52})));
      Buildings.Fluid.Sources.Outside souA(nPorts=1, redeclare package Medium =
            MediumA)
      ...
      Modelica.Blocks.Sources.Constant mFanFlo(k=mAir_flow_nominal)
        "Mass flow rate of fan" annotation (Placement(transformation(extent={{12,-90},
                {26,-76}})));
      Buildings.Fluid.Sensors.TemperatureTwoPort TCHW(m_flow_nominal=
        ...
        "Temperature of water leaving chiller " annotation (Placement(
            ...
            rotation=270,
            origin={-29,15})));
      Buildings.Fluid.Sensors.TemperatureTwoPort TCHWRtn(m_flow_nominal=
            mCHW_flow_nominal, redeclare package Medium = Medium2)
      ...
      Modelica.Blocks.Continuous.Integrator integratorPump
        annotation (Placement(transformation(extent={{82,14},{96,28}})));
    ...
    equation
      ...
      connect(chi.on, greaterThreshold.y) annotation (Line(
          ...
          color={255,0,255},
          smooth=Smooth.None));
      connect(TSetChi.y, chi.TSet) annotation (Line(points={{-75,2},{-50,2},{-50,43},
              {-4,43}},color={0,0,127}));
      connect(TAirOut.port_b,sinA. ports[1])
        annotation (Line(points={{-50,-52},{-72,-52}}, color={0,127,255}));
      connect(souA.ports[1], Fan.port_a)
      ...
      connect(souA.weaBus, weaData.weaBus) annotation (Line(
      ...
      connect(Fan.port_b, TAirFan.port_a) annotation (Line(points={{40,-52},{32,-52}},
                                       color={0,127,255}));
      connect(chi.P, integratorChi.u) annotation (Line(points={{19,55},{20,55},{20,85},
              {34.6,85}},         color={0,0,127}));
      connect(Fan.P, integratorFan.u) annotation (Line(points={{39,-61},{44,-61},{44,
              -69},{-2.6,-69}},       color={0,0,127}));
      connect(cooCoi.port_b2, TAirOut.port_a)
        annotation (Line(points={{-8,-52},{-30,-52}}, color={0,127,255}));
      connect(TAirFan.port_b, cooCoi.port_a2)
        annotation (Line(points={{22,-52},{12,-52}}, color={0,127,255}));
      connect(TCHWRtn.port_a, cooCoi.port_b1) annotation (Line(points={{38,-26},
              {38,-40},{12,-40}}, color={0,127,255}));
      connect(cooCoi.port_a1, TCHW.port_b) annotation (Line(points={{-8,-40},{-29,
              -40},{-29,8}}, color={0,127,255}));
      connect(expVesChi.port_a, TCHW.port_b) annotation (Line(points={{-14,-24},
              {-14,-34},{-29,-34},{-29,8}}, color={0,127,255}));
      connect(chi.port_b2, TCHW.port_a) annotation (Line(points={{-2,40},{-29,
              40},{-29,22}}, color={0,127,255}));
      connect(ChillerPump.P, integratorPump.u)
        annotation (Line(points={{47,25},{47,21},{80.6,21}},color={0,0,127}));
      connect(TCHWRtn.port_b, ChillerPump.port_a)
        annotation (Line(points={{38,-10},{38,4}}, color={0,127,255}));
      connect(chi.port_a2, ChillerPump.port_b)
...
First implementation.
    ...
    model ElectricEIRVP2
      ...
      Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi1(
        redeclare package Medium1 = Medium2,
        redeclare package Medium2 = MediumA,
        UA_nominal=mAir_flow_nominal*1006*5,
        dp1_nominal=1000 + 89580,
    ...
    equation
      ...
      connect(chi.P, integratorChi.u) annotation (Line(points={{19,55},{20,55},{20,77},
              {36.6,77}}, color={0,0,127}));
      connect(Fan.P, integratorFan.u) annotation (Line(points={{47,-71},{44,-71},{44,
              -75},{-2.6,-75}},   color={0,0,127}));
      connect(cooCoi1.port_b2, TAirOut.port_a)
        annotation (Line(points={{6,-62},{-34,-62}}, color={0,127,255}));
      connect(TAirFan.port_b, cooCoi1.port_a2)
        annotation (Line(points={{34,-62},{26,-62}}, color={0,127,255}));
      connect(TCHWRtn.port_a, cooCoi1.port_b1) annotation (Line(points={{42,-46},
              {42,-50},{26,-50}}, color={0,127,255}));
      connect(cooCoi1.port_a1, TCHW.port_b) annotation (Line(points={{6,-50},{-32,
              -50},{-32,-34}}, color={0,127,255}));
      connect(expVesChi.port_a, TCHW.port_b) annotation (Line(points={{-3,-40},
              {-3,-46},{-32,-46},{-32,-34}}, color={0,127,255}));
      connect(ChillerPump.port_b, chi.port_a2)
      ...
      connect(TCHW.port_a, splitter2.port_2)
        annotation (Line(points={{-32,-22},{-32,-10}}, color={0,127,255}));
      connect(chi.port_b2, splitter2.port_1) annotation (Line(points={{-2,40},{
              -32,40},{-32,2}}, color={0,127,255}));
      connect(TCHWRtn.port_b, ModulatingValve.port_a)
...
First implementation.
  ...
  package Task2c
    model ElectricEIRVFan
      ...
      replaceable package MediumW = Buildings.Media.Water "Medium model";
      parameter Modelica.SIunits.MassFlowRate mAir_flow_nominal=16 "Nominal mass flow rate at fan";
      parameter Modelica.SIunits.MassFlowRate mCHW_flow_nominal=1 "Nominal mass flow rate at chilled water";
      parameter Modelica.SIunits.MassFlowRate m_flow_nominal = mCHW_flow_nominal
        "Nominal mass flow rate";
      parameter Modelica.SIunits.Temperature TsetChi=280.15 "Chilled water set point";
      parameter Modelica.SIunits.Temperature TAirSet=286.15 "Cooled air set point";
      ...
      Task2_3.Task2b.ElectricEIRCW chi(
        redeclare package Medium2 = Medium2,
        per=per,
        energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
        dp1_nominal=6000,
      ...
      Buildings.Fluid.Sensors.TemperatureTwoPort TAirOut(m_flow_nominal=
        ...
        "Temperature of air leaving cooling coil" annotation (Placement(
            ...
            rotation=0,
            origin={-40,-56})));
      Buildings.Fluid.Sources.Outside souA(          redeclare package Medium =
            MediumA, nPorts=1)
    ...
    equation
      connect(chi.port_b1, res1.port_a) annotation (Line(
          points={{18,54},{26,54},{26,52},{34,52}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(chi.on, greaterThreshold.y) annotation (Line(
          points={{-4,51},{-10,51},{-10,86},{-25,86}},
          color={255,0,255},
          smooth=Smooth.None));
      connect(TSetChi.y, chi.TSet) annotation (Line(points={{-75,2},{-50,2},{-50,45},
              {-4,45}},color={0,0,127}));
      connect(cooCoi.port_b2,TAirOut. port_a) annotation (Line(points={{-12,-56},{-30,
              -56}},                    color={0,127,255}));
      connect(TAirOut.port_b,sinA. ports[1])
      ...
      connect(souA.weaBus, weaData.weaBus) annotation (Line(
          ...
          color={255,204,51},
          thickness=0.5));
      connect(cooCoi.port_a1, expVesChi.port_a) annotation (Line(points={{-12,-44},{
              -19,-44},{-19,-34}},   color={0,127,255}));
      connect(ChillerPump.port_b, chi.port_a2)
        annotation (Line(points={{38,20},{38,42},{18,42}},color={0,127,255}));
      connect(ChillerPump.m_flow_in, mPumpFlo1.y) annotation (Line(points={{26,10},{
              16,10},{16,28},{73.2,28}}, color={0,0,127}));
      connect(cooCoi.port_a1, TCHW.port_b)
        annotation (Line(points={{-12,-44},{-32,-44},{-32,-6}},
                                                              color={0,127,255}));
      connect(TCHW.port_a, chi.port_b2)
        annotation (Line(points={{-32,14},{-32,42},{-2,42}},color={0,127,255}));
      connect(cooCoi.port_b1, TCHWRtn.port_a)
        annotation (Line(points={{8,-44},{38,-44},{38,-30}},  color={0,127,255}));
      connect(TCHWRtn.port_b, ChillerPump.port_a)
        annotation (Line(points={{38,-10},{38,0}},   color={0,127,255}));
      connect(TAirOutSet.y, conPID.u_s)
        annotation (Line(points={{10.6,-82},{14,-82},{14,-84},{18.8,-84}},
                                                         color={0,0,127}));
      connect(TAirOut.T, conPID.u_m) annotation (Line(points={{-40,-67},{-40,-98},{26,
              -98},{26,-91.2}},    color={0,0,127}));
      connect(Fan.port_b, cooCoi.port_a2)
        annotation (Line(points={{42,-56},{8,-56}},  color={0,127,255}));
      connect(Fan.port_a, souA.ports[1])
      ...
      connect(sou1.ports[1], chi.port_a1) annotation (Line(points={{-70,52},{-36,52},
              {-36,54},{-2,54}},color={0,127,255}));
      ...
      connect(Fan.P, integratorFan.u) annotation (Line(points={{41,-65},{2,-65},{2,-69},
              {-9,-69}}, color={0,0,127}));
      connect(chi.P, integratorChi.u) annotation (Line(points={{19,57},{26,57},{26,77},
              {36.6,77}}, color={0,0,127}));
      annotation (
    experiment(Tolerance=1e-6, StopTime=14400),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Chillers/Examples/ElectricEIR.mos"
  ...
  package Task3
    ...
    model PVSimpleOriented
      ...
      Buildings.Electrical.DC.Sources.PVSimpleOriented
        ...
        A=3800,
        til=0.4607669225265,
        lat=0.72256631032565)  "PV module"
        annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            origin={46,40})));
